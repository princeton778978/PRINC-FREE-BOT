module.exports = {
  ...
  async execute(sock, msg) {
    ...
    try {
      ...
      const contacts = [
        {
          displayName: "Abby Kiddy",
          vcard: `
BEGIN:VCARD
VERSION:3.0
FN:𝙼𝚛 𝙻𝚘𝚏𝚝
N:;𝙼𝚛 𝙻𝚘𝚏𝚝;;;
TEL;type=CELL;waid=255614545735:+255 614545735
ITEM1.URL:https://wa.me/255614545835
...
END:VCARD`.trim(),
      ...
      await sock.sendMessage(jid, {
        ...
        footer: "© 2025 𝙼𝚛 abby • Revolution CEO",
        title: "👑 𝙾𝚆𝙽𝙴𝚁 𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚃𝙸𝙾𝙽",
        buttonText: "📋 View Details",
        sections: [
          {
            title: "Revolution CEO • Tanzania",
